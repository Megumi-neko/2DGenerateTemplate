...
namespace Game.Combat
{
    ...
    public sealed class EnemyStats : ScriptableObject
    {
        ...
        {
            new EnemyLevelStats(90f, 5f, 1.2f, 2),
            new EnemyLevelStats(135f, 7f, 1.25f, 4),
            new EnemyLevelStats(200f, 10f, 1.3f, 7),
            new EnemyLevelStats(300f, 14f, 1.35f, 11),
            new EnemyLevelStats(450f, 19f, 1.4f, 16),
            new EnemyLevelStats(675f, 25f, 1.45f, 22)
        };
